...
─────────  ─────────  ─────────  ─────────  ─────────
1 週         2〜3 週     8〜9 週     1.5〜2 週   人間担当
                                     （Claude 主導） （Claude は staging までを完成）
```
...
**期間**: 1.5〜2 週（開発フェーズ末尾と一部オーバーラップ可）
...
| Phase 検証 完了 (受入ゲート) | 開発完了後 1.5〜2 週 | 5 トラック合格、go/no-go レポート提出 |
| Phase 導入 完了 (本番稼働) | 人間判断 | 学校 OK + 契約 OK + パイロット完了後 |

---

## ペネトレ計画（2026-05-31 更新）
