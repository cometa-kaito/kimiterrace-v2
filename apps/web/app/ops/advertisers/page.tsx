...
const BASE_PATH = "/ops/advertisers";
...
/**
 * F10 (#46) / UIUX-03: システム管理者の広告主一覧 (`/ops/advertisers`)。**Server Component**。
 *
      ...
      <header style={headerStyle}>
        ...
        <div style={headerRightStyle}>
          ...
          {/* 商流SoR一元化 Phase1 (2026-06-13): 広告主の新規登録は portal (K3 自動生成) が一元管理する
              ため、v2 の手動「新規登録」導線 (/ops/advertisers/new) は撤去した。本画面は
        ...
        rows={rows.map((a) => ({
          ...
          cells: [
            ...
            <span key="actions" style={actionsLinksStyle}>
              ...
              <Link href={`/ops/advertisers/${a.id}/ads`} style={editLinkStyle}>
                広告
              </Link>
              <Link href={`/ops/advertisers/${a.id}/edit`} style={editLinkStyle}>
                編集
              </Link>
            </span>,
          ],
