...
/**
 * F13 (#391 / #408, ADR-020): 来場検知センサー管理画面 `/app/sensors`。**Server Component**。
 *
  ...
  return (
    <section>
      <div style={headerStyle}>
        ...
        {canWrite ? (
          <a href="/app/sensors/new" style={registerLinkStyle}>
            ＋ センサーを登録
          </a>
        ) : null}
      </div>
    ...
    <tr style={decommissioned ? decommissionedRowStyle : undefined}>
      ...
      <td style={tdLeftStyle}>
        <span style={actionsCellStyle}>
          <a
            href={`/app/sensors/${sensor.id}/history`}
            style={editLinkStyle}
          ...
          {canWrite ? (
            <a
              href={`/app/sensors/${sensor.id}/edit`}
              style={editLinkStyle}
