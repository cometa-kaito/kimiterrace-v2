  ...
  return (
    <div style={{ maxWidth: "780px" }}>
      ...
      <div style={quickRowStyle}>
        ...
        <Link href="/admin/editor/scope/school" style={commonBtnStyle}>
              ...
              {departments.map((d) => (
                <section key={d.id}>
                  <div style={sectionHeadStyle}>
                    ...
                    <Link href={`/admin/editor/scope/department/${d.id}`} style={scopeChipStyle}>
                      この学科の共通 →
                    </Link>
                  </div>
      ...
      {grades.map((g) => (
        <div key={g.id}>
          <div style={sectionHeadStyle}>
            ...
            <Link href={`/admin/editor/scope/grade/${g.id}`} style={scopeChipStyle}>
              この学年の共通 →
            </Link>
          </div>
          {g.classes.length === 0 ? (
            ...
            <div style={classGridStyle}>
              {g.classes.map((c) => (
                <Link key={c.id} href={`/admin/editor/${c.id}`} style={classTileStyle}>
