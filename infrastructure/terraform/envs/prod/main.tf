...
locals {
  ...
  web_image_tag = "863251d" # hotfix #1070: サイネージ poll 応答の Date 復元(ニュース帯 getTime クラッシュ解消)。90878a3 + #1070 のみ cherry-pick した最小デルタ(main HEAD の #1061 prod未適用migration を避ける)。schema/secret 変更なし・web のみ。疎通 /api/health 200 + /login private,no-cache
}
