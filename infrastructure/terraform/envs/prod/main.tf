...
locals {
  ...
  web_image_tag = "b11a359" # prod deploy b11a359（#1196 反映・pattern1 予定の空列を罫線プレースホルダーで埋めず完全な空列に＝「----」解消。schema/secret 無変更・migration なし・疎通 health200/login private,no-cache・rev 00127-4gl）
}
