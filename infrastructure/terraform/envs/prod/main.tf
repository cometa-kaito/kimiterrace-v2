...
locals {
  ...
  web_image_tag = "65b038f" # prod deploy 65b038f（#1171 カレンダー枠を全幅+本体中央寄せ ＋ 中間merge #1166/#1170 盤面規定枠ぶん入力行の事前生成[予定/連絡/提出物＋来校者/呼出]・schema/secret 無変更・migration なし・疎通 health200/login private,no-cache・rev 00119-lfs）
}
