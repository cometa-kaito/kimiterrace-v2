...
locals {
  ...
  web_image_tag = "9900018" # 2026-07-12: 年間行事UI改善3件（#1276 プレビュー日付編集フォーカス修正+年度和文 / #1277 取込を＋ボタン開閉に / #1278 置換保存確認に差分表示）。schema・secret 無変更=migrate 不要。疎通 /api/health=200・/login cache-control=private,no-cache
}
