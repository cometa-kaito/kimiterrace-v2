...
locals {
  ...
  web_image_tag = "9285fbc" # prod #1148(エディタAIチャットで複数日まとめ下書き・migration無) 隔離デプロイ=ebc6b69 app+#1148のみ。#1145(時限その他)/#1146(呼出D&D)とmigration 0035は次回main HEAD正規リリースで反映。schema/secret無変更 疎通200/no-cache
}
