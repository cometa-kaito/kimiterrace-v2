...
locals {
  ...
  web_image_tag = "a7a7ea1" # prod deploy a7a7ea1（#1159 教員エディタUX: 並び替えタッチ対応(Pointer Events)/日付カレンダー(内容ドット)/予定の対象日UI整理・schema/secret 無変更・疎通 health200/login private,no-cache・rev 00114-cdn）
}
