...
locals {
  ...
  web_image_tag = "4b03464" # prod deploy 4b03464（#1176 予定の時限プルダウンを 1〜6 限に絞る[7〜12 撤去・UI 選択肢のみ／サーバ検証は 1〜12 のまま] ＋ 中間merge #1172 bump/#1174 予定事前生成行は時限空欄/#1173 連絡並べ替えハンドル空行除外/#1175 来校者呼出並べ替えで実入力行を末尾空行へ落とさない・schema/secret 無変更・migration なし・疎通 health200/login private,no-cache・rev 00120-7m4）
}
