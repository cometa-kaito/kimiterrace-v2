...
locals {
  ...
  web_image_tag = "ba363f5" # prod #1137(signage pattern3 行数固定+想定文字数フィット:予定5/人物4/ニュース見出し1行+本文4行/検知数拡大)+#1138(wysiwygテストmock)+#1136(教員エディタ自動保存) schema/secret無変更 疎通200/no-cache
}
