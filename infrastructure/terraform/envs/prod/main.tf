...
locals {
  ...
  web_image_tag = "c104130" # prod deploy c104130（#1189 教員エディタ「別の日も準備する」カレンダーUX改善[自動スクロール/明日・あさってチップ/トグルボタン化/今日クリック空振り解消/過去日無効化]。schema/secret 無変更・migration なし・疎通 health200/login private,no-cache・rev 00124-nmf）
}
