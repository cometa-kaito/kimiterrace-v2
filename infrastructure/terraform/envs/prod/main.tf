...
locals {
  ...
  web_image_tag = "8726aef" # 2026-06-13 deploy: 学校管理画面(/admin/school)のUI再設計（3色・⋯メニュー集約・要整理→学科へ移動・クラス単位/学年単位トグル・restrict削除）#866 反映（schema 無変更=migrate 不要・疎通200/no-cache 確認済）
}
