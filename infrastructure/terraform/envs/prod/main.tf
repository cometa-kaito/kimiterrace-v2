...
locals {
  ...
  web_image_tag = "dfc0c5a" # 2026-06-13 deploy: 0d74d6d は 98ea09a の app code + 本 infra bump commit（app コード同一）。商流SoR削除(advertisers new/contracts/communications/memberships #853) + BUG-3 学科制クラス識別(#848) + pattern2(#850) 反映（schema 無変更=migrate 不要・疎通200/no-cache 確認済）
}
