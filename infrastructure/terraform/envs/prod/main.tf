...
locals {
  ...
  web_image_tag = "91d024f" # prod deploy 91d024f（#1192 予定「科目のみ（時限なし）」表示可＋場所/対象者を pattern1/3 盤面表示。schema/secret 無変更・migration なし・疎通 health200/login private,no-cache・rev 00125-9jh）
}
