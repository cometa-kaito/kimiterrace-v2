...
locals {
  ...
  web_image_tag = "592b366" # 個別教員アカウント(系統B)撤去・system_admin側 deploy 2026-06-10: /admin/system/users の teacher 発行/ロール変更撤去・共通教員を一覧非表示（#788）。_APP_URL=app.school-signage.net 維持
}
