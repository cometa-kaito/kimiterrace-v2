...
locals {
  ...
  web_image_tag = "48a9a33" # prod deploy 48a9a33（#1194 AI下書きSectionDraftPanelの時限selectに「（時限なし）」option追加・本体ScheduleEditorと同期。schema/secret 無変更・migration なし・疎通 health200/login private,no-cache・rev 00126-45j）
}
